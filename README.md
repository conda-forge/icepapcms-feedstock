...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/icepapcms-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13659&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/icepapcms-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `icepapcms` can be installed with:

```
conda install icepapcms
```

It is possible to list all of the versions of `icepapcms` available on your platform with:
